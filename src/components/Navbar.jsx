...
function Navbar() {
    ...
    return (
        <nav className="sticky bottom-0 z-50 w-full bg-white border-t-2 sm:hidden dark:bg-dark border-slate-300 dark:border-slate-100">
            <div className="flex items-center justify-between px-8 py-3 text-center text-slate-500 dark:text-slate-400">
                <Link className={pathname === '/world' && 'dark:text-white text-black'} to="/world">
                    <img src={WorldIcon} alt="World Icon" className="w-8 mx-auto" />
                    <p className="mt-1 text-[14px]">Thế Giới</p>
                </Link>
                <Link
